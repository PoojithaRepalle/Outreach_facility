...
public class button5 extends AppCompatActivity {
    ...
    private static final String INITIAL_URL = "https://drive.google.com/drive/folders/1yHrhq-mlTpi4CjL46Hpf1dTV9hcXVsug?usp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.equals(BLOCKED_URL)) {
                    Toast.makeText(button5.this, "Access to this URL is restricted.", Toast.LENGTH_SHORT).show();
                    return true;
                } else {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                } else if (ContextCompat.checkSelfPermission(button5.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(button5.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_STORAGE_PERMISSION);
                } else {
                    downloadFile(url, contentDisposition, mimeType);
                }
            }
