...
public class button4 extends AppCompatActivity {
    ...
    private static final String INITIAL_URL = "https://drive.google.com/drive/folders/1e7AGKVGnvJRWd5seI_PJgUM2PUdwbyAs?usp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.equals(BLOCKED_URL)) {
                    Toast.makeText(button4.this, "Access to this URL is restricted.", Toast.LENGTH_SHORT).show();
                    return true;
                } else {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                } else if (ContextCompat.checkSelfPermission(button4.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(button4.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_STORAGE_PERMISSION);
                } else {
                    downloadFile(url, contentDisposition, mimeType);
                }
            }
